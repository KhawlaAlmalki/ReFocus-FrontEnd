      ...
      <div className="min-h-screen flex items-center justify-center px-4 py-12 bg-white">
        ...
        <Card className="w-full max-w-md p-8 md:p-12 rounded-3xl border border-border/50 backdrop-blur-sm shadow-lg text-center">
          ...
          <p className="text-muted-foreground mb-8">
            Your account has been created successfully. Now you can log in and start your focus journey.
          </p>
      ...
      <Card className="w-full max-w-md p-8 md:p-12 rounded-3xl border border-border/50 backdrop-blur-sm shadow-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              className={`rounded-xl py-3 px-4 transition-all duration-200 ${
                errors.fullName ? 'border-destructive bg-destructive/5' : 'hover:border-primary/30 focus:border-primary'
              }`}
            />
            {errors.fullName && <p className="text-destructive text-sm font-medium">{errors.fullName}</p>}
          </div>
          ...
          <div className="space-y-2">
            ...
            {password && (
              <div className="flex items-center gap-2 text-sm pt-2">
                ...
                <span className={`font-medium ${getStrengthColor()}`}>{getStrengthText()}</span>
              </div>
            )}
          ...
          <div className="space-y-2">
            ...
            {errors.confirmPassword && <p className="text-destructive text-sm font-medium">{errors.confirmPassword}</p>}
          </div>
          ...
          <div className="space-y-2">
            ...
            <Select value={role} onValueChange={(value) => setRole(value as UserRole)}>
              ...
              <SelectContent>
                <SelectItem value="end-user">Student / Professional (End User)</SelectItem>
